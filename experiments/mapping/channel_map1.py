...
## imports
from preparation import prep_comp, epoch_comp, prep_pilot, epoch_pilot, comp_channel_map1
...
CLASSES = 2
FOLDS = 9
GOODS = ['Fz','FC3','FC1','FC2','FC4','C5','C3','C1','Cz','C2','C4','C6','CP5','CP3','CPz','CP4','CP6','P3','Pz','P4','POz']
KERNELS = 1
WEIGHT_PATH = f"weights/competition/subject-separated/{CLASSES}class/{FOLDS}fold/channel_map1"
...
### script start
_compX, _compY = epoch_comp(prep_comp(comp_channel_map1, GOODS), CLASSES)
