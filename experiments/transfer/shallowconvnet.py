...
from evaluation import ShallowConvNet, get_fold, add_kernel_dim, onehot, test_val_rest_split, test_model
...
LO_FREQ = 4.
HI_FREQ = 32.
WEIGHT_PATH = f"weights/competition/subject-separated/{CLASSES}class/{FOLDS}fold/shallowconv"
...
for i in range(0, FOLDS):
  ...
  # initialise model
  model = ShallowConvNet(nb_classes=CLASSES, Chans=chans, Samples=samples, dropoutRate=0.5)
